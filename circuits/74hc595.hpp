...
class HC595 {
 public:
    ...
    /** @brief Default value to pulse time, in nanoseconds. */
    static constexpr uint kDefaultPulseTime = 15;
    /** @brief Constructor. */
    HC595();
    /**
     * @brief Constructor.
     ...
     */
    explicit HC595(uint sinPin, uint clkPin = 0xFF, uint clrPin = 0xFF,
